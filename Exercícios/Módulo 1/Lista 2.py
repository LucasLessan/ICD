# -*- coding: utf-8 -*-
"""Copy of dcc212l2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/103-oOVnSi9LjnmQxyUG1O9CH8nlCXoYx
...
def north_or_south():
    df2 = df.loc[['Dez', 'Jan', 'Fev']]
    df2_mean = df2.mean()
    df3 = df.loc[['Jun', 'Jul', 'Ago']]
    df3_mean = df3.mean()
    if df2_mean['icecream'] > df2_mean['coats'] and df3_mean['icecream'] < df3_mean['coats']:
        return 'Sul'
    else:
        return 'Norte'
