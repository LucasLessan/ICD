...
Original file is located at
    https://colab.research.google.com/drive/1l-6uVs4NBUJKJ2_Zbh2b03qB5EKHTKzZ
...
def sum_of_squared_errors(alpha, beta, x, y):
    ...
    err = 0
    for i in range(n):
        err += error(alpha, beta, x[i], y[i]) ** 2
    return err
...
def r_squared(alpha, beta, x, y):
    num = sum_of_squared_errors(alpha, beta, x, y)
    den = total_sum_of_squares(y)
    return 1 - num / den
...
ss.probplot(y - np.mean(y), plot=plt)
plt.show()
